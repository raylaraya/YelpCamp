/*
    If we are running our code in development mode and not production mode
...
const sessionConfig = {
    ...
    cookie: {
        // this makes cookies only accessible through http and not javascript
        // prevents cookies from being stolen
        httpOnly: true,
        // cookies can only be configured over secure connections(https)
        // secure: true,
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/dpahchhsg/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
